...
&  \Pi_{o,z,t} + f^{charge}_{o,z,t} + \Theta_{o,z,t} + f^{discharge}_{o,z,t} + r^{dischttps://github.com/vinaykonuru/GenX.githttps://github.com/vinaykonuru/GenX.githttps://github.com/vinaykonuru/GenX.githttps://github.com/vinaykonuru/GenX.githttps://github.com/vinaykonuru/GenX.githttps://github.com/vinaykonuru/GenX.githarge}_{o,z,t} \leq \Delta^{total}_{o,z} & \quad \forall o \in \mathcal{O}^{sym}, z \in \mathcal{Z}, t \in \mathcal{T} \\
\end{aligned}
```
